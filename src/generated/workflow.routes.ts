...
/**
 * Auto-generated Workflow Routes
 *
...
/**
 * Set hooks for Workflow routes
 */
export function setWorkflowHooks(h: WorkflowHooks) {
  hooks = h
}
...
const WRITABLE_SCALAR_FIELDS = ["name", "description", "steps", "status", "companyId", "createdAt"] as const
...
export function createWorkflowRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Workflow not found" } }, 404)
      }
