...
/**
 * Hooks for BrainMemory routes
 */
export interface BrainMemoryHooks {
  /**
...
/**
 * Default BrainMemory hooks (customize as needed)
 */
export const brainMemoryHooks: BrainMemoryHooks = {
