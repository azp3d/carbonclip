...
/**
 * Hooks for AgentMessage routes
 */
export interface AgentMessageHooks {
  /**
...
/**
 * Default AgentMessage hooks (customize as needed)
 */
export const agentMessageHooks: AgentMessageHooks = {
