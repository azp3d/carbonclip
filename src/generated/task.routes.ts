...
const WRITABLE_SCALAR_FIELDS = ["title", "description", "status", "priority", "assigneeId", "companyId", "departmentId", "dueDate", "output", "createdAt", "updatedAt"] as const
const RELATION_FIELDS = ["assignee", "company", "department"] as const
