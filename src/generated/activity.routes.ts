...
import type { ActivityHooks } from "./activity.hooks"
...
/**
 * Set hooks for Activity routes
 */
export function setActivityHooks(h: ActivityHooks) {
  hooks = h
}
...
const WRITABLE_SCALAR_FIELDS = ["type", "message", "agentName", "companyId", "createdAt"] as const
...
export function createActivityRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Activity not found" } }, 404)
      }
