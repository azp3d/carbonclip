...
/**
 * Auto-generated Department Routes
 *
...
import type { DepartmentHooks } from "./department.hooks"
...
/**
 * Set hooks for Department routes
 */
export function setDepartmentHooks(h: DepartmentHooks) {
  hooks = h
}
...
const WRITABLE_SCALAR_FIELDS = ["name", "description", "icon", "companyId", "createdAt"] as const
const RELATION_FIELDS = ["company", "agents", "tasks"] as const
...
/**
 * Create Department CRUD routes
 */
export function createDepartmentRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Department not found" } }, 404)
      }
